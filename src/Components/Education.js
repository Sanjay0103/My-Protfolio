        ...
        <div className='w-[95%] p-6 md:p-10 rounded-3xl mx-auto max-w-full mt-20 bg-gray-800' id='experience'>
            ...
            <ol class="relative border-s border-gray-700 mt-10">
                <li class="mb-10 ms-6 px-1 md:px-3">
                    ...
                    <h3 class="flex items-center mb-1 text-[1rem] md:text-lg font-semibold text-white">B.E Electronics and Communication Engineering </h3>
                    <time class="block mb-2 text-sm font-normal leading-none text-gray-400 ">sri shakthi institute of engineering and technology  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  2019 - 2023</time>
