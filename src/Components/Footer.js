        ...
        <>
            <div className='mt-36 bg-gray-950 py-10 md:px-20 px-5 '>
                ...
                <div className="flex items-center lg:justify-between justify-center flex-wrap">
                    <div className="flex items-center justify-center w-fit gap-2 pl-2 pr-5 py-1 rounded-full bg-gray-900 scale-90">
                        <div className="ml-2 p-1">
                            <div className="text-[1.3rem] font-[600] text-gray-100">SANJAY KUMAR</div>
                            <a href='mailto:sanjaysiva808@gmail.com' className="text-[12px] text-gray-600">sanjaysiva808@gmail.com</a>
                        </div>
                    </div>
                ...
                <div className="flex items-center gap-5 mt-10 px-3 py-1 rounded-full bg-gray-900 w-fit xl:mx-0 mx-auto">
                    <a title='Connect with Email' href="mailto:sanjaysiva808@gmail.com" className='text-gray-500' ><IoIosMail className='text-[2.3rem]' /></a>
                    <Link title='Connect with GitHub' to={"https://github.com/Sanjay0103"} target='_blank' className='text-gray-500' ><FaGithub className='text-[2rem]' /></Link>
                    <Link title='Connect with Linked In' to={"https://www.linkedin.com/in/sanjay-kumar-s-/"} target='_blank' className='text-gray-500' ><FaLinkedin className='text-[2rem]' /></Link>
                </div>
            </div>
            <div className="py-5 tracking-wider font-[200] text-center bg-black text-white">Copyright 2024 by Sanjay kumar</div>
        </>
    )
}
