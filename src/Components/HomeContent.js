        ...
        <section class=" mt-20">
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                ...
                <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 md:px-0 px-5">
                    ...
                    <a href={Resume} onClick={() => DownloadSuccessFunc()} download className={`py-3 flex items-center justify-center gap-2 px-5 sm:ms-4 text-sm font-medium  focus:outline-none  tracking-wide rounded-lg border focus:z-10 focus:ring-4 focus:ring-gray-100  ${downloadSuccess ? "bg-emerald-600 text-white" : "bg-gray-800 text-gray-400 border-gray-600"}`}>
